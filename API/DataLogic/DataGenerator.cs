namespace API.DataLogic
{
    ...
    public static class DataGenerator
    {
        public static InMemoryDataLogic GenerateData()
        {
            ...
            Guid contentId = dataLogic.AddContent("Dark outside? Blinds down", "<h3 style='color: red'>You are now in a secure zone. Leaving the blinds open while it's dark outside lets outsiders look in. </h3>");
